        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-16">
          <div className="flex flex-col gap-6">
            <motion.div
              ...
              {...(!shouldUseSafeMotion && fadeInUp(0.3))}
            >
            ...
            <motion.p
              ...
              {...(!shouldUseSafeMotion && fadeInUp(1.0))}
            >
              {profile.strapline}
            </motion.p>
            ...
            <motion.p
              ...
              {...(!shouldUseSafeMotion && fadeInUp(1.2))}
            >
            ...
            <motion.div
              ...
              {...(!shouldUseSafeMotion && fadeInUp(1.4))}
            >
              <Button
                variant="primary"
                onClick={() => {
          ...
          <motion.div
            ...
            {...(!shouldUseSafeMotion && fadeInScale(0.6))}
          >
